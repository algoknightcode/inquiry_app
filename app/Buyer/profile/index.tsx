          ...
          <View className="items-center relative">
            ...
            <View className="relative mb-4">
              <View className="h-24 w-24 rounded-full bg-blue-50 border-2 border-blue-100 items-center justify-center">
                <Text className="text-4xl font-jakarta-bold text-blue-900">B</Text>
              </View>
            ...
            <Text className="text-2xl font-jakarta-bold text-slate-900 tracking-tight">Buyer Profile</Text>
            <Text className="text-[15px] font-jakarta-medium text-slate-500 mb-6">Manage your business details</Text>
          </View>
        </View>
